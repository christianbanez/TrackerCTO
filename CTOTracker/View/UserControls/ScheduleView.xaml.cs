...
namespace CTOTracker.View
{
    ...
    public partial class ScheduleView : UserControl
    {
        ...
        private void ctoUseDataGrid_AutoGeneratedColumns(object sender, EventArgs e)
        {
            ...
            ctoUseDataGrid.Columns[0].Width = 75;
            ...
            ctoUseDataGrid.Columns[3].Visibility = Visibility.Collapsed;
            ...
            ctoUseDataGrid.Columns[7].Width = 200;
            ...
            foreach (var column in ctoUseDataGrid.Columns)
            {
                if (column is DataGridTextColumn textColumn)
                {
                    ...
                    if (textColumn.Header.ToString() == "Infor ID" ||
                        ...
                        textColumn.Header.ToString() == "CTO Used" ||
                        textColumn.Header.ToString() == "Date Used")
                    {
        ...
        private void scheduleDataGrid_AutoGeneratedColumns(object sender, EventArgs e)
        {
            ...
            scheduleDataGrid.Columns[3].Width = 155;
            scheduleDataGrid.Columns[4].Header = "Task";
            scheduleDataGrid.Columns[4].Width = 110;
            ...
            foreach (var column in scheduleDataGrid.Columns)
            {
                if (column is DataGridTextColumn textColumn)
                {
                    // Apply the custom cell style to specific columns
                    if (textColumn.Header.ToString() == "Infor ID" ||
                        textColumn.Header.ToString() == "Start Date" ||
                        textColumn.Header.ToString() == "End Date" ||
                        textColumn.Header.ToString() == "CTO Earned" ||
                    ...
                    else if (textColumn.Header.ToString() == "Time In" || textColumn.Header.ToString() == "Time Out")
                    {
                        textColumn.Binding.StringFormat = "h:mm tt"; // Format time in 12-hour format with AM/PM
                        textColumn.CellStyle = FindResource("CenteredDataGridCell") as Style;
                        textColumn.HeaderStyle = FindResource("CenteredDataGridColumnHeader") as Style;
                    }
                }
        ...
        private void ApplyCenteredCellStyle(DataGridColumn column)
        {
            if (column != null)
            {
                column.CellStyle = FindResource("CenteredDataGridCell") as Style;
        ...
        private void ctoUseDataGrid_AutoGeneratingColumn(object sender, DataGridAutoGeneratingColumnEventArgs e)
        {
